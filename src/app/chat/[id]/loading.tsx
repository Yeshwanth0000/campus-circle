...
export default function ChatThreadLoading() {
  return (
    <div className="mx-auto flex h-[calc(100vh-120px)] w-full max-w-none animate-skeleton-in flex-col px-3 py-3 sm:h-[calc(100vh-126px)] sm:max-w-[min(94vw,72rem)] sm:px-4 sm:py-4 lg:h-[calc(100vh-64px)]">
